...
const TodoListContent = ({todos,deleteTodo,toggleComplete,editTodoList}) => {
    return (
        <div className="bg-white rounded border shadow-sm mt-4 mb-5" >
           <FilterContent/> 
           <hr className='my-0'></hr>
           <ListContent todos={todos} deleteTodo={deleteTodo} toggleComplete={toggleComplete} editTodoList={editTodoList}/>
        </div>
...
const ListContent = ({todos,deleteTodo,toggleComplete,editTodoList}) => {
    return(
        <div>
              ...
              <div className="row">
                ...
                <div className="col-auto order-2 mb-1 order-sm-3 text-end">
                  <div className="btn-group" aria-label="Edit">
                    <button type="button" disabled={todo.completed}  className={`btn btn-sm ${
                    ...
                    <button type="button" disabled={todo.completed} className="btn btn-sm btn-outline-primary editBtn" onClick={() => editTodoList(todo)}>
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pencil" viewBox="0 0 16 16">
                        <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325"/>
                      </svg>
                    </button>
                   
                    <button type="button" disabled={todo.completed} className="btn btn-sm btn-outline-danger btnDelete" onClick={()=> deleteTodo(todo.id)}>
                  ...
                  <div className="row gx-2">
                    ...
                    <div className="col-sm-auto mt-2 mt-sm-0 d-flex align-items-center gap-2">
                      ...
                      <span className="badge text-bg-secondary text-white py-1 spanAttachment">
                       ...
                       <span className="todoAttachement">{todo.attachments}{todo.attachments === 1 ? "attachment" : "attachments"} </span> 
                      </span>
                      }
                    </div>
                  </div>
